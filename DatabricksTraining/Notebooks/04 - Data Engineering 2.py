...
airlinecodefilepath = "file:/Workspace/Repos/v.david@kovalibre.com/DatabricksTraining/Data/asa/airlinecodes/airlinecodes.csv"

airlinecodeDF= (spark
            .read
            .option("header", True)
            .option("inferSchema", True)
            .csv(airlinecodefilepath))

airlinecodeDF.write.mode("overwrite").saveAsTable("airlines.airlinecodes")
...
# MAGIC + located in the folder **file:/Workspace/Repos/v.david@kovalibre.com/DatabricksTraining/Data/initech/orders**
...
orderfilepath = "file:/Workspace/Repos/v.david@kovalibre.com/DatabricksTraining/Data/initech/orders"
...
# If you want to read data from CSV file
csv_product_path = "file:/Workspace/Repos/v.david@kovalibre.com/DatabricksTraining/Data/initech/productsCsv/product.csv"
product_from_csv = (spark.read
    .option("header", True)
    .csv(csv_product_path)) 
display(product_from_csv)
